    ...
    <div className="explore-container">
      <div className="explore-inner_container">
        ...
        <div className="flex gap-1 px-4 w-full rounded-lg bg-dark-4 py-4">
          <img src={user.imageUrl} alt="/assets/icons/profile-placeholder.svg" className="rounded-full h-20 w-20 md:h-36 md:w-36" />
          <div className="name">
            <div className="flex">
            <h2 className=" h4-bold mx-6 md:h2-bold md:mx-10">{user.name}</h2>
            <img src="/assets/icons/edit.svg" height={20} width={20} alt="edit" className="align-right" />
            </div>
            
            <h3 className="mx-6 h4 md:mx-10">{`@${user.username}`}</h3>
            <div>
              <p className="mx-6 md:mx-10 mt-2 max-w-44">{user.bio}</p>
            </div>
          </div>
